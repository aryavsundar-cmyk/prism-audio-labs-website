...
import { collections, totalPluginCount, completeSuitePrice, getPluginImage, pluginImageMap } from '@/data/plugins';
...
export default function Home() {
  ...
  const heroBgImages = [
    ...
    { id: 'nebula-mfx', pos: 'bottom-[10%] right-[12%]', size: 'w-[300px] h-[300px]', opacity: 'opacity-[0.06]' },
  ];
  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        {/* Full-bleed hero background MidJourney images */}
        <div className="pointer-events-none absolute inset-0">
        ...
        <div className="relative mx-auto max-w-5xl px-6 pt-24 pb-20 text-center">
          ...
          <div className="mb-10 inline-flex items-center gap-2.5 rounded-full border border-white/[0.06] bg-white/[0.02] px-5 py-2">
            ...
            <span className="text-sm text-slate-400">50 Plugins — Available Now</span>
          </div>
          ...
          <p className="mx-auto mt-8 max-w-xl text-lg leading-relaxed text-slate-400">
            ...
            analog circuitry and spectral synthesis. Four collections. No boundaries.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/pricing"
              className="rounded-xl bg-prism-cyan px-8 py-3.5 text-[15px] font-bold text-[#14152E] transition hover:bg-prism-cyan/85"
            >
              Get the Complete Suite — ${completeSuitePrice}
            </Link>
            <Link
              href="/collections/dragonbreath"
              className="rounded-xl border border-white/[0.08] px-8 py-3.5 text-[15px] text-slate-400 transition hover:border-white/15 hover:text-white"
            >
              Explore Collections
            </Link>
          </div>
      ...
      {/* ───── INFINITE MARQUEE (Wall of Plugins) ───── */}
      <InfiniteMarquee />
      ...
      <section className="py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white">Four Dimensions of Sound</h2>
            <p className="mt-3 text-base text-slate-400">Each collection is a signal path into uncharted territory.</p>
          </div>

          <div className="grid gap-6 sm:grid-cols-2">
            {collections.map((col) => {
              // Get first 3 plugin images for 3-image strip
              ...
              return (
                <Link
                  ...
                  className="group relative rounded-2xl border border-white/[0.08] bg-[#14152E] overflow-hidden transition hover:border-prism-violet/20"
                >
                  {/* 3-image strip header */}
                  <div className="relative h-36 overflow-hidden flex">
                    {stripImages.map((img, idx) => (
                      <div key={img.id} className="relative flex-1 overflow-hidden">
                        ...
                        {idx < stripImages.length - 1 && (
                          <div className="absolute right-0 inset-y-0 w-px bg-white/[0.06] z-10" />
                        )}
                      </div>
                    ))}
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#14152E]" />
                    {/* Collection accent gradient overlay */}
                  ...
                  <div className="p-10 pt-4">
                    ...
                    <div className="mt-8 flex items-center justify-between">
                      ...
                      <span className="text-sm text-slate-400 transition group-hover:text-slate-300">Explore →</span>
                    </div>
                  </div>
                </Link>
              );
                  ...
                  <div className="rounded-2xl border border-white/[0.08] bg-[#14152E] overflow-hidden transition hover:border-prism-violet/20">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        <span className="text-xs text-slate-400 transition group-hover:text-slate-300">View →</span>
                      </div>
                    </div>
                  </div>
                </Link>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/[0.08]">
                <div className="relative aspect-square">
                  <Image
                    src={getPluginImage('dragonbreath-pedal')!}
                    alt="Dragonbreath Pedal"
                    fill
            ...
            <div>
              ...
              <p className="mt-6 text-[16px] leading-[1.8] text-slate-400">
                Four-stage multi-effect engine with cascading saturation, tempo-synced modulation, filtered delay, and convolution reverb in a single signal path. Parallel dry/wet routing with per-stage gain staging — the kind of architecture you&apos;d build with a rack of outboard, collapsed into one plugin.
              </p>
              ...
              <div className="mt-10 flex items-center gap-6">
                <Link
                  href="/plugins/dragonbreath-pedal"
                  className="rounded-xl bg-gradient-to-r from-orange-600 to-red-600 px-7 py-3 text-[15px] font-bold text-white transition hover:opacity-90"
                >
                  View Dragonbreath
                </Link>
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="relative">
            ...
            <p className="mt-5 text-base text-slate-400">
              Shape the frequencies that shape the future.
            </p>
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Link href="/pricing" className="rounded-xl bg-prism-cyan px-8 py-3.5 text-[15px] font-bold text-[#14152E] transition hover:bg-prism-cyan/85">
                Get Started — ${completeSuitePrice}
              </Link>
